...
function lmt_post_admin_actions() {
    ...
    // hook into all posts
    add_action ( "manage_post_posts_custom_column", "lmt_post_columns_data");
    ...
    foreach ( $post_types  as $ptc ) {
        ...
        add_filter ( "manage_{$ptc}_sortable_columns", "lmt_post_columns_display");

        add_action ( "manage_{$ptc}_posts_custom_column", "lmt_post_columns_data");
