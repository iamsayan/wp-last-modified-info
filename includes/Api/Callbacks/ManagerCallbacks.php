...
class ManagerCallbacks
{
	...
	public function date_type( $args ) {
		$this->do_field( [
			...
			'options'     => [
				'wordpress'      => __( 'Default WordPress Format', 'wp-last-modified-info' ),
				'human_readable' => __( 'Human Readable Format', 'wp-last-modified-info' ),
				'default'        => __( 'Custom Format', 'wp-last-modified-info' ),
			],
			'show_if'     => 'wplmi_enable_plugin',
		] );
	}
	...
	public function astra_support( $args ) {
		$this->do_field( [
			'type'        => 'select',
			'id'          => $args['label_for'],
			'name'        => 'lmt_tt_astra_theme_mod',
			'value'       => $this->get_data( 'lmt_tt_astra_theme_mod', 'none' ),
			'description' => __( 'Enable the Astra Theme Support form here. It will replace the post meta published date with post modified date.', 'wp-last-modified-info' ),
			'options'     => [
	...
	public function generatepress_support( $args ) {
		$this->do_field( [
			'type'        => 'select',
			'id'          => $args['label_for'],
			'name'        => 'lmt_tt_generatepress_theme_mod',
			'value'       => $this->get_data( 'lmt_tt_generatepress_theme_mod', 'none' ),
			'description' => __( 'Enable the GeneratePress Theme Support form here. It will replace the post meta published date with post modified date.', 'wp-last-modified-info' ),
			'options'     => [
				'none'    => __( 'Use Default Post Date', 'wp-last-modified-info' ),
				'replace' => __( 'Replace Post Meta Data', 'wp-last-modified-info' ),
			],
	...
	public function theme_template_type( $args ) {
		$this->do_field( [
			'type'        => 'select',
			'id'          => $args['label_for'],
			'name'        => 'lmt_tt_theme_template_type',
			'value'       => $this->get_data( 'lmt_tt_theme_template_type', 'custom' ),
			'description' => __( 'Set the template type from here to diaplay on post meta.', 'wp-last-modified-info' ),
			'options'     => [
