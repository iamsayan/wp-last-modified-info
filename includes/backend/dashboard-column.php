...
function lmt_last_modified_info_on_column( $column, $post_id ) {
    ...
    case 'modified':
        ...
        $modified = date($get_df . ' @ ' . $get_tf, $m_stamp );
                ...
                if ( $p_meta  == 'yes' ) {
                    echo ' <span class="lmt-lock dashicons dashicons-lock" title="' . esc_attr__( 'Modified date time update is disabled.', 'wp-last-modified-info' ) . '" style="font-size:16px;"></span>';
                }
