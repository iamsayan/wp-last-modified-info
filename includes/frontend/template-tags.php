...
function get_the_last_modified_info() {
    ...
    if( !empty( $options['lmt_tt_author_sep'] ) ) {
        $author_sep_tt = ' ' . esc_html( $options['lmt_tt_author_sep'] );
    } else {
        $author_sep_tt = ' by';
    }
    ...
    if( !empty( $options['lmt_tt_class_box'] ) ) {
        $lmt_template_tag = '<span class="'. esc_html( $options['lmt_tt_class_box'] ) .'"><span class="tt-last-modified-text">' . $last_modified_text . '</span> <time' . $schema_tt . '>' . $lmt_tt_ud . '</time>' . $lmt_tt_uca . '</span>';
    } else {
        $lmt_template_tag = '<span><span class="tt-last-modified-text">' . $last_modified_text . '</span> <time' . $schema_tt . '>' . $lmt_tt_ud . '</time>' . $lmt_tt_uca . '</span>';
    }
