...
function lmt_plug_settings_page() {
    ...
    add_settings_section('lmt_post_option_section', __( 'Post Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_post_option');
        ...
        add_settings_field('lmt_enable_schema_on_post_cb',  __( 'Enable Inline Schema Markup:', 'wp-last-modified-info' ), 'lmt_enable_schema_on_post_cb_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-enable-schema' ));  
        ...
        if( count( $post_types ) >= 1 ) {
            add_settings_field('lmt_custom_post_types_list',  __( 'Enable on This Custom Post Types:', 'wp-last-modified-info' ), 'lmt_custom_post_types_list_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'cpt', 'class' => 'cpt' ));  
        }
    ...
    add_settings_section('lmt_schema_section', __( 'Schema Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_schema_option');
        add_settings_field('lmt_enable_jsonld_markup_cb', __( 'Enable JSON-LD Schema Markup:', 'wp-last-modified-info' ), 'lmt_enable_jsonld_markup_cb_display', 'lmt_schema_option', 'lmt_schema_section', array( 'label_for' => 'schema-jsonld' ));
        add_settings_field('lmt_enable_jsonld_markup_post_types', __( 'Select Post Types for JSON-LD Markup:', 'wp-last-modified-info' ), 'lmt_enable_jsonld_markup_post_types_display', 'lmt_schema_option', 'lmt_schema_section', array( 'label_for' => 'schema-jsonld-pt', 'class' => 'schema-jsonld-pt' ));
        add_settings_field('lmt_enable_schema_support_cb', __( 'Enable Enhanced Schema Support:', 'wp-last-modified-info' ), 'lmt_enable_schema_support_cb_display', 'lmt_schema_option', 'lmt_schema_section', array( 'label_for' => 'schema-support' ));
