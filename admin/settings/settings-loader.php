...
function lmt_plug_settings_page() {
    ...
    add_settings_section('lmt_post_option_section', __( 'Post Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_post_option');
        ...
        add_settings_field('lmt_enable_human_format_cb',  __( 'Show as Human Readable Format:', 'wp-last-modified-info' ), 'lmt_enable_human_format_cb_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-human' ));  
        add_settings_field('lmt_enable_last_modified_time_cb',  __( 'Show Last Modified Time on Posts:', 'wp-last-modified-info' ), 'lmt_enable_last_modified_time_cb_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-enable-time', 'class' => 'post-time' ));  
        add_settings_field('lmt_enable_last_modified_date_cb',  __( 'Show Last Modified Date on Posts:', 'wp-last-modified-info' ), 'lmt_enable_last_modified_date_cb_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-enable-date', 'class' => 'post-date' ));  
        add_settings_field('lmt_post_date_time_sep',  __( 'Date / Time Seperator on Posts:', 'wp-last-modified-info' ), 'lmt_post_date_time_sep_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-dt-sep', 'class' => 'post-sep' )); 
        ...
        add_settings_field('lmt_custom_post_types_list',  __( 'Include Custom Post Types (if any):', 'wp-last-modified-info' ), 'lmt_custom_post_types_list_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'cpt' ));  
    ...
    add_settings_section('lmt_page_option_section', __( 'Page Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_page_option');    
        ...
        add_settings_field('lmt_enable_human_format_page_cb', __( 'Show as Human Readable Format:', 'wp-last-modified-info' ), 'lmt_enable_human_format_page_cb_display', 'lmt_page_option', 'lmt_page_option_section', array( 'label_for' => 'page-human' ));  
        add_settings_field('lmt_enable_last_modified_time_page_cb', __( 'Show Last Modified Time on Pages:', 'wp-last-modified-info' ), 'lmt_enable_last_modified_time_page_cb_display', 'lmt_page_option', 'lmt_page_option_section', array( 'label_for' => 'page-enable-time', 'class' => 'page-time' ));  
        add_settings_field('lmt_enable_last_modified_date_page_cb', __( 'Show Last Modified Date on Pages:', 'wp-last-modified-info' ), 'lmt_enable_last_modified_date_page_cb_display', 'lmt_page_option', 'lmt_page_option_section', array( 'label_for' => 'page-enable-date', 'class' => 'page-date' ));  
        add_settings_field('lmt_page_date_time_sep', __( 'Date / Time Seperator on Pages:', 'wp-last-modified-info' ), 'lmt_page_date_time_sep_display', 'lmt_page_option', 'lmt_page_option_section', array( 'label_for' => 'page-dt-sep', 'class' => 'page-sep' )); 
    ...
    add_settings_section('lmt_template_tag_section', __( 'Template Tags Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_template_tag_option');
        add_settings_field('lmt_tt_enable_cb', __( 'Enable Template Tags Functionality:', 'wp-last-modified-info' ), 'lmt_tt_enable_cb_display', 'lmt_template_tag_option', 'lmt_template_tag_section', array( 'label_for' => 'lmt-tt' ));  
        add_settings_field('lmt_enable_human_format_tt_cb', __( 'Show as Human Readable Format:', 'wp-last-modified-info' ), 'lmt_enable_human_format_tt_cb_display', 'lmt_template_tag_option', 'lmt_template_tag_section', array( 'label_for' => 'lmt-tt-human' ));  
        add_settings_field('lmt_tt_set_format_box', __( 'Last Modified date/time format:', 'wp-last-modified-info' ), 'lmt_tt_set_format_box_display', 'lmt_template_tag_option', 'lmt_template_tag_section', array( 'label_for' => 'lmt-tt-format', 'class' => 'lmt-tt-format' ));  
