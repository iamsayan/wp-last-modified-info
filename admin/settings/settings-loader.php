...
function lmt_plug_settings_page() {
    ...
    add_settings_section('lmt_post_option_section', __( 'Post Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_post_option');
        ...
        add_settings_field('lmt_enable_schema_on_post_cb',  __( 'Enable Schema Markup on Posts:', 'wp-last-modified-info' ), 'lmt_enable_schema_on_post_cb_display', 'lmt_post_option', 'lmt_post_option_section', array( 'label_for' => 'post-enable-schema' ));  
    ...
    add_settings_section('lmt_page_option_section', __( 'Page Options', 'wp-last-modified-info' ) . '<p><hr></p>', null, 'lmt_page_option');    
        ...
        add_settings_field('lmt_enable_schema_on_page_cb',  __( 'Enable Schema Markup on Pages:', 'wp-last-modified-info' ), 'lmt_enable_schema_on_page_cb_display', 'lmt_page_option', 'lmt_page_option_section', array( 'label_for' => 'page-enable-schema' ));  
