...
function lmt_enable_human_format_cb_display() {
    ?>  <label class="switch">
        ...
        <div class="slider round"></div></label>&nbsp;&nbsp;&nbsp;<span class="tooltip" title="Enable this if you want to show last modified info on posts as human readable format i.e. days / weeks / years ago. It will override next three options."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_show_last_modified_time_date_post_display() {
    ...
    echo "</select>";
    ?>
    &nbsp;&nbsp;<span id="show-shortcode" style="display:none;"><i>Shortcode: <code>[lmt-post-modified-info]</code></i>&nbsp;&nbsp;</span><span class="tooltip" title="Select where you want to show last modified info on a single posts. If you select 'Before Content or After Content', you can disable auto insert on particular posts from post edit screen > WP Last Modified Info meta box."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_show_author_cb_display() {
    ...
    ?>
    <span id="post-custom-author" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="custom-post-author" style="font-size:13px;"><strong>Select:</strong></label>&nbsp;&nbsp;
    <?php
    ...
    echo "</select>";
    ?>
    </span><span id="post-author-link" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="post-authorlink" style="font-size:13px;"><strong>Link:</strong></label>&nbsp;&nbsp;
    <label class="switch">
...
function lmt_enable_human_format_page_cb_display() {
    ?>  <label class="switch">
        ...
        <div class="slider-pg round-pg"></div></label>&nbsp;&nbsp;&nbsp;<span class="tooltip" title="Enable this if you want to show last modified info on pages as human readable format i.e. days / weeks / years ago. It will override next three options."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_show_last_modified_time_date_page_display() {
    ...
    echo "</select>";
    ?>
    &nbsp;&nbsp;<span id="show-shortcode-page" style="display:none;"><i>Shortcode: <code>[lmt-page-modified-info]</code></i>&nbsp;&nbsp;</span><span class="tooltip" title="Select where you want to show last modified info on a page. If you select 'Before Content or After Content', you can disable auto insert on particular posts from page edit screen > WP Last Modified Info meta box."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_show_author_page_cb_display() {
    ...
    echo "</select>";
    ?>
    <span id="page-custom-author" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="custom-page-author" style="font-size:13px;"><strong>Select:</strong></label>&nbsp;&nbsp;
    <?php
    ...
    echo "</select>";
    ?>
    </span><span id="page-author-link" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="page-authorlink" style="font-size:13px;"><strong>Link:</strong></label>&nbsp;&nbsp;
    <label class="switch">
...
/*function lmt_hide_disable_update_display() {
    $options = get_option('lmt_plugin_global_settings');
    
    if(!isset($options['lmt_hide_disable_update'])){
        $options['lmt_hide_disable_update'][] = '';
    }

    global $wp_roles;
    echo "<select id='disable-update' name='lmt_plugin_global_settings[lmt_hide_disable_update][]' multiple='multiple' style='width:65%;'>";
    foreach ( $wp_roles->roles as $key=>$value ) {
        $selected = in_array( $key, $options['lmt_hide_disable_update'] ) ? 'selected="selected"' : '';
        echo "<option value='$key' $selected>" . $value['name'] . "</option>";
    }
    echo "</select>";
    ?>
    &nbsp;&nbsp;<span class="tooltip" title="Select user roles for which you want to show 'Don't update modified info anymore' checkbox on post / page edit screen."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}*/
...
function lmt_show_author_tt_cb_display() {
    ...
    echo "</select>";
    ?>
    <span id="tt-custom-author" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="lmt-custom-tt-author" style="font-size:13px;"><strong>Select:</strong></label>&nbsp;&nbsp;
    <?php
    ...
    echo "</select>";
    ?>
    </span><span id="tt-author-link" style="display:none;">&nbsp;&nbsp;&nbsp;<label for="lmt-tt-authorlink" style="font-size:13px;"><strong>Link:</strong></label>&nbsp;&nbsp;
    <label class="switch">
...
function lmt_tt_class_box_display() {
    ?> <input id="lmt-tt-class" name="lmt_plugin_global_settings[lmt_tt_class_box]" type="text" size="50" style="width:40%;" placeholder="e.g. entry-time" value="<?php if (isset(get_option('lmt_plugin_global_settings')['lmt_tt_class_box'])) { echo get_option('lmt_plugin_global_settings')['lmt_tt_class_box']; } ?>" />
...
function lmt_enable_on_admin_bar_cb_display() {
    ?>  <label class="switch">
        ...
        <div class="slider-misc round-misc"></div></label>&nbsp;&nbsp;&nbsp;<span class="tooltip" title="Enable this if you want to show last modified info on wordpress admin bar."><span title="" class="dashicons dashicons-editor-help"></span></span>
    <?php
}
...
function lmt_custom_style_box_display() {
    ...
    <br><small>Do not add <strong>'&lt;style&gt; &lt;/style&gt;'</strong> tag. This tag is not required, as it is already added.</small>
    <?php
}
