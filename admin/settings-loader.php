...
function lmt_plug_settings_page() {
    ...
    add_settings_section("lmt_post_option_section", "Post Options<p><hr></p>", null, "lmt_post_option");
        ...
        add_settings_field("lmt_enable_custom_post_types", "<label for='cpt'>Enable for Custom Post Types (Frontend):</label>", "lmt_enable_custom_post_types_display", "lmt_post_option", "lmt_post_option_section");  
        ...
        add_settings_field("lmt_use_as_sc_cb", "<label for='post-sc'>Disable Auto Insert on All Posts:</label>", "lmt_use_as_sc_cb_display", "lmt_post_option", "lmt_post_option_section");  
    ...
    add_settings_section("lmt_page_option_section", "Page Options<p><hr></p>", null, "lmt_page_option");    
        ...
        add_settings_field("lmt_use_as_sc_page_cb", "<label for='page-sc'>Disable Auto Insert on All Pages:</label>", "lmt_use_as_sc_page_cb_display", "lmt_page_option", "lmt_page_option_section");  
    ...
    add_settings_section("lmt_dashboard_option_section", "Dashboard Options<p><hr></p>", null, "lmt_dashboard_option");
        ...
        add_settings_field("lmt_enable_custom_field_cb", "<label for='custom-field'>Add Last Modified Info in Custom Fields:</label>", "lmt_enable_custom_field_cb_display", "lmt_dashboard_option", "lmt_dashboard_option_section");
