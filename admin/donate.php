...
function lmt_donate_admin_notice() {
    ...
    if ( lmt_plugin_installed_time_donate() > strtotime( '-360 hours' )
        ...
        || apply_filters( 'lmt_plugin_show_sticky_donate_notice', false ) ) {
        return;
    }
    ...
    <div class="notice notice-success">
        ...
        <a href="<?php echo $no_thanks; ?>" class="later"><strong><?php _e( 'Nope&#44; maybe later', 'wp-last-modified-info' ); ?></strong></a></p>
    </div>
<?php
}
