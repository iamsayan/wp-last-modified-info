...
function lmt_rating_admin_notice() {
    ...
    $dismiss = wp_nonce_url( add_query_arg( 'lmt_rating_notice_action', 'dismiss_rating_true' ), 'dismiss_rating_true' ); 
    $no_thanks = wp_nonce_url( add_query_arg( 'lmt_rating_notice_action', 'no_thanks_rating_true' ), 'no_thanks_rating_true' ); ?>
